...
while read sentence; do
    ...
    trips-cli render -p $2/$index/parse.json -f svg -o $2/$index/best
    trips-cli render -p $2/$index/parse.json -f svg -o $2/$index/first -a 0
    trips-cli render -p $2/$index/parse.json -f svg -o $2/$index/second -a 1
